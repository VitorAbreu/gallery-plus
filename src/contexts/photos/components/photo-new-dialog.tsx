...
export default function PhotoNewDialog({ trigger }: PhotoNewDialogProps) {
  ...
  // resolve as validações do formulário com base no schema passado no zodResolver
  ...
  function handleToggleAlbum(albumId: string) {
    ...
    const albumsSet = new Set(albumsIds); // set é um array que não recebe valores repetidos
